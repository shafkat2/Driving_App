...
data2 = Mini_batch_wavelet_denoising(data1,200,4,"coif1",5,10,4)
...
data1  = Mini_batch_wavelet_denoising(data2,100,2,"coif2",4,10,4)
...
@app.route('/v1/api/refill', methods=['GET'] )
def api_refill():
